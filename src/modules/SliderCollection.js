...
class Slider {
  ...
  constructor(rootElement) {
    ...
    this.previousButotnElement = this.navigationElement.querySelector(this.selectors.previousButton);
  ...
  init() {
    new Swiper(this.swiperElement, {
      ...
      navigation: { prevEl: this.previousButotnElement, nextEl: this.nextButtonElement },
      pagination: {
        el: this.paginationElement,
        bulletClass: "slider-navigation__pagination-bullet",
        bulletActiveClass: "is-active",
      },
      scrollbar: { el: this.scrollbarElement, dragClass: "slider__scrollbar-drag" },
    });
  }
}
